...
test("microwave can cook and displays decrementing time", async () => {
    ...
    expect(console.log.mock.calls[0][0]).toBe("Entering number 3 *Beep*")
...
test("enterDigit validation", async () => {
    ...
    // More than 4 inputs
    expect(console.log.mock.calls[4][0]).toBe("Entering number 0 *Beep*")
    expect(console.log.mock.calls[5][0]).toBe("00:00")
    expect(console.log.mock.calls[6][0]).toBe("Entering number 0 *Beep*")
    expect(console.log.mock.calls[7][0]).toBe("00:00")
    expect(console.log.mock.calls[8][0]).toBe("Entering number 0 *Beep*")
    expect(console.log.mock.calls[9][0]).toBe("00:00")
    expect(console.log.mock.calls[10][0]).toBe("Entering number 1 *Beep*")
